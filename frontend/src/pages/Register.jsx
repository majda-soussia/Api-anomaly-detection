...
// Même logo que Login.jsx
const LogPulseLogo = () => (
  <svg width="160" viewBox="0 0 680 200" xmlns="http://www.w3.org/2000/svg">
    <circle cx="150" cy="100" r="52" fill="none" stroke="#111111" strokeWidth="1.5" />
    <path
      d="M 106,100 L 122,100 L 128,76 L 136,128 L 143,100 L 149,86 L 155,100 L 194,100"
      fill="none"
      stroke="#111111"
      strokeWidth="1.5"
      strokeLinecap="round"
    ...
    <text fontFamily="'Helvetica Neue', Helvetica, Arial, sans-serif" fontSize="56" y="117">
      <tspan x="228" fontWeight="200" fill="#111111" opacity="0.55">
        Log
      </tspan>
      <tspan fontWeight="300" fill="#111111">
        Pulse
      </tspan>
    </text>
  </svg>
...
// Tu peux copier exactement le CSS de Login.jsx
const styles =  `
            ...
            <div className="login-wrapper">
                ...
                <div className="login-card">
                    ...
                    <p className="card-sub">
                        Your account will be created with the Viewer role.
                    </p>
